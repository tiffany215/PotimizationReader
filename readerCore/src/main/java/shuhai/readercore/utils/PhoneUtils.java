...
public final class PhoneUtils {
    ...
    public static String getUUID() {
        String uniqueId;
        final TelephonyManager tm = (TelephonyManager) Utils.getAppContext()
...
//    }
    ...
    public static void dial(final String phoneNumber) {
        Utils.getAppContext().startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        Utils.getAppContext().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        Utils.getAppContext().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(Utils.getAppContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = Utils.getAppContext().getContentResolver();
