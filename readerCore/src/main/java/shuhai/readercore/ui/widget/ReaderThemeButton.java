package shuhai.readercore.ui.widget;
...
public class ReaderThemeButton extends android.support.v7.widget.AppCompatImageView {
    ...
    public ReaderThemeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mRadiusColor = a.getColor(R.styleable.RoundImageViewByXfermode_type,Color.BLACK);
