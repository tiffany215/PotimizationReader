...
import shuhai.readercore.common.ViseConfig;
import shuhai.readercore.utils.AppUtils;
import shuhai.readercore.utils.MD5Utils;
...
public class DiskCache  {
    ...
    public DiskCache(Context context) {
        this(getDiskCacheDir(context, ViseConfig.CACHE_DISK_DIR),calculateDiskCacheSize(getDiskCacheDir(context, ViseConfig.CACHE_DISK_DIR)));
    }

    public DiskCache(File diskDir, long diskMaxSize) {
...
//        put(key, value != null ? FastJsonUtils.collectToString(value) : null);
    }
    ...
    public String getMd5Key(String key) {
        return MD5Utils.getMessageDigest(key.getBytes());
    }
